...
> [!IMPORTANT]
> Algunas funciones del bot requieren el uso de APIs externas. El bot está adaptado para trabajar con [api.lempi.lat](https://api.lempi.lat). Puedes crear una cuenta, copiar tu ApiKey y colocarla en el archivo `.env`, reemplazando el texto correspondiente:  
> `API_KEY="<TU_APIKEY>"`
